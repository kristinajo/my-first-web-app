...
var TransactionSearchService = (function () {
    function TransactionSearchService(http) {
        this.http = http;
        this.transactionUrl = 'http://localhost:8091/transactions/by-account';
    }
    TransactionSearchService.prototype.search = function (term) {
        return this.http
